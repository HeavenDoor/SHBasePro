...
// 为经纪人房源详情而建的协议 Created by leoll on 16/8/27.
@protocol TankCycleScrollViewDelegate <NSObject>

@optional
- (void)tankCycleScrollViewDidScroll:(UIScrollView *)scrollView;
...
/** 代理 Created by leoll on 16/8/27.*/
@property (nonatomic,weak) id<TankCycleScrollViewDelegate> delegate;
