...
@implementation UIControl (SequenceClick)
...
{
    if (NSDate.date.timeIntervalSince1970 - self.uxy_acceptedEventTime < self.uxy_acceptEventInterval)
    {
        NSLog(@"相应间隔范围内不予处理");
        return;
    }
