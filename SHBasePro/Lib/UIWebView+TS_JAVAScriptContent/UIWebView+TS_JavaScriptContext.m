...
static UIWebView *g_webViews = nil;
...
//
//            if ( [ctx[cookie].toString isEqualToString: cookie] || [ctx[cookie].toString isEqualToString:@"undefined"])
//            {
//                [webView ts_didCreateJavaScriptContext: ctx];
//                return;
//            }
